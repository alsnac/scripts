...
def xml_to_csv(path):
    ...
    for xml_file in tq.tqdm(glob.glob(path + '/*.xml')):
        ...
        for member in root.findall('object'):
            ...
            list_of_box.append(int(float(bndbox.find('xmin').text)))
            list_of_box.append(int(float(bndbox.find('ymin').text)))
            list_of_box.append(int(float(bndbox.find('xmax').text)))
            list_of_box.append(int(float(bndbox.find('ymax').text)))
